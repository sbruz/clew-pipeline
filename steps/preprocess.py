...
def simplify_text_for_beginners(book_id: int, lang: str, max_chars: int):
    ...
    system_prompt = (
        "Ты — языковой помощник. Твоя задача: адаптировать текст главы книги для читателей уровня B1.\n"
        "Правила:\n"
        "- Сохрани исходный язык оригинала книги.\n"
        "- Не меняй структуру, сохрани исходную разбивку по абзацам.\n"
        "- Не удаляй и не объединяй абзацы.\n"
        "- Упрощай лексику и грамматику, делая текст современным, простым и понятным с уровнем знаний A2-B1. По возможности разбивай сложные предложения на простые.\n"
